...
private:
    std::array<std::array<unsigned short, N_MOVES+1>, 2187> corner_moves;
    std::array<std::array<unsigned short, N_MOVES+1>, 2048> edge_moves;
    std::array<std::array<unsigned short, N_MOVES+1>, 495> ud_moves;
